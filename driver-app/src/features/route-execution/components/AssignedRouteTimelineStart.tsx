...
export function AssignedRouteTimelineStart({ start, onNavigate }: AssignedRouteTimelineStartProps) {
  return (
    <button
      className="w-full appearance-none bg-transparent border-none p-0 text-left"
      onClick={onNavigate}
      type="button"
    >
