...
export const RouteGroupBoundaryLocationCard = ({
  ...
  return (
    <div
      className={`admin-glass-panel admin-surface-compact flex justify-between rounded-2xl border border-border p-4 transition-all duration-200 hover:border-border-accent hover:bg-surface-hover ${containerClassName ?? ''}`}
    >
