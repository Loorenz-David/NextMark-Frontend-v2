      ...
      >
        <Field label="">
          <SegmentedSelect
            ...
            styleConfig={{
              textSize: '12px',
              containerBg: 'color-mix(in srgb, var(--foreground-mark) 4.5%, transparent)',
              containerBorder: 'color-mix(in srgb, var(--foreground-mark) 14%, transparent)',
              containerShadow: 'inset 0 1px 0 var(--paper-raised)',
              selectedBg: 'linear-gradient(180deg, rgba(var(--info-r),0.22), rgba(var(--info-r),0.16))',
              selectedBorder: 'rgba(var(--info-r),0.42)',
              selectedShadow: 'inset 0 1px 0 color-mix(in srgb, var(--foreground-mark) 14%, transparent)',
