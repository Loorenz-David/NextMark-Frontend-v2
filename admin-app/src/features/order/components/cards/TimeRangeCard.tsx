...
const defaultTimeContainerClass =
  'items-center rounded-2xl border border-[rgba(var(--accent-r),0.24)] bg-[linear-gradient(135deg,rgba(var(--accent-r),0.18),rgba(var(--accent-r),0.09))] px-3 py-2.5 shadow-[var(--shadow-button-xs-accent)]'
