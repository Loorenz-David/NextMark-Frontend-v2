...
const defaultTimeContainerClass =
  'items-center rounded-2xl border border-[rgba(112,222,208,0.24)] bg-[linear-gradient(135deg,rgba(72,180,194,0.18),rgba(111,224,207,0.09))] px-3 py-2.5 shadow-[0_6px_14px_rgba(54,182,194,0.06)]'
