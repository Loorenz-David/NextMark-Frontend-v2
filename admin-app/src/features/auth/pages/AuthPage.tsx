...
export function AuthPage() {
  ...
  return (
    <section className="relative flex min-h-dvh items-center justify-center overflow-hidden bg-[#131a1b] px-4 py-8 text-text sm:px-6">
      ...
      <div className="relative z-10 flex w-full max-w-md flex-col items-center gap-3">
        <motion.div
          ...
          className="relative w-full overflow-hidden rounded-4xl border border-border bg-surface-hover p-5 shadow-[0_28px_90px_rgba(0,0,0,0.34)] backdrop-blur-2xl sm:p-7"
        >
          ...
          <div className="relative flex flex-col gap-6">
            <header className="space-y-3 text-center">
              ...
              <h1 className="text-4xl font-semibold tracking-[-0.04em] text-text sm:text-[2.8rem]">
                Admin panel access
              </h1>
        ...
        <p className="text-center text-xs font-medium tracking-[0.12em] text-faint">
