...
export const buttonVariantClasses: Record<ButtonVariant, string> = {
  ...
  textInvers:
    'bg-[var(--color-primary)] border border-border hover:bg-[color-mix(in_srgb,var(--color-primary)_88%,white)] inline-flex items-center justify-center rounded-xl px-3 py-1.5 text-xs font-semibold uppercase tracking-[0.2em] text-[var(--color-secondary)] shadow-[0_12px_30px_rgba(131,204,185,0.22)]',
  secondaryInvers:
    'bg-[rgba(14,22,23,0.72)] text-[var(--color-primary-foreground)] border border-border hover:bg-[rgba(9,15,16,0.82)] inline-flex items-center justify-center rounded-xl px-3 py-1.5 text-sm font-medium shadow-[0_12px_28px_rgba(0,0,0,0.18)]',
  primary:
  ...
  darkGray:
    'bg-surface-hover text-[var(--color-primary-foreground)] border border-border hover:bg-surface-sunken inline-flex items-center justify-center rounded-xl px-3 py-1.5 text-sm font-medium',
  darkBlue:
    'bg-[var(--color-dark-blue)]/85 text-[var(--color-primary-foreground)] border border-border hover:bg-[var(--color-dark-blue)] inline-flex items-center justify-center rounded-xl px-3 py-1.5 text-sm font-medium shadow-[0_12px_28px_rgba(96,141,232,0.20)]',
  secondary:
